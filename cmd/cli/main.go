		...
		Commands: []*cli.Command{
			...
			},
			{
				...
				Commands: []*cli.Command{
					...
					{
						Name:   "persona",
						Usage:  "Set or get a namespace persona (system prompt)",
						Action: namespacePersonaCmd,
						Flags: []cli.Flag{
							&cli.StringFlag{Name: "persona", Aliases: []string{"p"}, Usage: "The persona text (system prompt)"},
						},
					},
				},
			},
				...
				Commands: []*cli.Command{
					...
					},
					{
						...
						Flags: []cli.Flag{
							...
							&cli.BoolFlag{Name: "mermaid", Aliases: []string{"m"}, Usage: "Output Mermaid.js diagram"},
						},
					},
					{
						Name:   "delete",
			...
			},
			{
				...
				Commands: []*cli.Command{
					...
					{
						Name:   "triage",
						Usage:  "Manually trigger root-cause analysis for a failure",
						Action: failureTriageCmd,
					},
				},
			},
			{
